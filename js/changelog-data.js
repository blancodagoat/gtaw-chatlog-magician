const CHANGELOG_ENTRIES = [
    {
        ...
        categories: {
            'New Features': [
                ...
                'Users can now choose simplified coloring for low/lower voice lines regardless of character name presence',
            ...
            'Character Name Detection': [
                ...
                'Enhanced consistency across all low/lower voice line types with unified coloring behavior'
            ],
            'User Experience': [
                'Added toggle functionality that respects user preferences for character name coloring',
                'Toggle state persists during session and affects all low/lower voice line processing',
